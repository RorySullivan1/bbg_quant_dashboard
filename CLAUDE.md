...
- **Platform** — full-width all-catalog performance grid (every index
  ...
  **Z-Score ranking** control row above the grid (Metric: Sharpe/Sortino/
  ...
  sunburst sits the **Regime Analysis** section (v0.8.5): shared regime controls
  ...
  **Risk vs Return** (a 2D per-strategy annualized vol-vs-return scatter colored
  ...
  view. Section 2 is a **sunburst** nested **asset class → theme → ticker**
  ...
  to the chosen metric/window, and the hover shows the arc's % of parent. The
